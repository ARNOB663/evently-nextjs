...
export function EnhancedUserProfile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Cover Section */}
      <div className="relative h-64 md:h-80 bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 via-cyan-500/20 to-blue-500/20" />
      </div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-4">
                    ...
                    {profileData.role && (
                      <Badge variant="secondary">
                        ...
                        {profileData.role === 'host' ? 'Host' : 'User'}
                      </Badge>
                    )}
                  </div>
                </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {(profileData.phoneNumber || profileData.dateOfBirth || profileData.gender || profileData.occupation || profileData.company) && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {(profileData.interests?.length > 0 || profileData.preferredEventTypes?.length > 0) && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profileData.interests.map((interest: string) => (
                      <Badge key={interest} variant="secondary" className="bg-teal-100 text-teal-900 border-teal-200">
                        {interest}
                      </Badge>
                    ))}
                  </div>
              ...
              {profileData.preferredEventTypes?.length > 0 && (
                <div>
                  <div className="text-sm font-medium text-gray-700 mb-2">Preferred Event Types</div>
                  <div className="flex flex-wrap gap-2">
                    {profileData.preferredEventTypes.map((type: string) => (
                      <Badge key={type} variant="secondary" className="bg-blue-100 text-blue-900 border-blue-200">
                        {type}
                      </Badge>
                    ))}
                  </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {profileData.socialMediaLinks.instagram && (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-700 group-hover:text-teal-600">Instagram</span>
                  </a>
                )}
                {profileData.socialMediaLinks.twitter && (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-700 group-hover:text-teal-600">Twitter</span>
                  </a>
                )}
                {profileData.socialMediaLinks.facebook && (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-700 group-hover:text-teal-600">Facebook</span>
                  </a>
                )}
                {profileData.socialMediaLinks.linkedin && (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-700 group-hover:text-teal-600">LinkedIn</span>
                  </a>
                )}
                {profileData.socialMediaLinks.website && (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-700 group-hover:text-teal-600">Website</span>
                  </a>
                )}
              </div>
            </CardContent>
      ...
      <Card className="hover:shadow-lg transition-all duration-200 cursor-pointer group">
        <CardContent className="p-0">
          {event.image ? (
            ...
            <div className="h-48 bg-gradient-to-br from-teal-100 to-cyan-100 flex items-center justify-center rounded-t-xl">
              ...
              <Card className="hover:shadow-lg transition-all duration-200 cursor-pointer group text-center p-4">
                {friend.profileImage ? (
                  <ImageWithFallback
                    ...
                    alt={friend.fullName}
                    className="w-20 h-20 rounded-full object-cover mx-auto mb-3 border-2 border-white group-hover:border-teal-500 transition-all"
                  />
                ) : (
                  <div className="w-20 h-20 rounded-full bg-teal-100 flex items-center justify-center mx-auto mb-3 border-2 border-white group-hover:border-teal-500 transition-all">
                    <User className="w-10 h-10 text-teal-600" />
                  </div>
                )}
                <h4 className="font-medium text-gray-900 group-hover:text-teal-600 transition-colors truncate">
                  {friend.fullName}
                </h4>
                {friend.location && (
