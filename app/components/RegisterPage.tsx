        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative bg-white/90 backdrop-blur-2xl rounded-[2rem] shadow-xl border border-white/40 p-8 sm:p-10">
                ...
                <div className="text-center mb-8">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">Sign up as a user to discover and join amazing events</p>
                  </motion.div>
                </div>
          ...
          >
            <div className="relative w-full max-w-md">
              ...
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-3">Mobile-First Experience</h2>
                <p className="text-gray-700 max-w-xs mx-auto">Sign up in seconds and start discovering amazing events on any device</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
