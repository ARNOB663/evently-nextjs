...
import { Mail, Lock, ArrowRight, UserCog, Eye, EyeOff, Sparkles } from 'lucide-react';
        ...
        >
          <div className="bg-white/90 backdrop-blur-lg rounded-[2.5rem] p-6 sm:p-8 lg:p-12 shadow-2xl border border-white/40">
            ...
            <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 sm:pl-12 py-5 sm:py-6 rounded-2xl border-2 border-gray-200 focus:border-purple-400 transition-colors"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="pl-11 sm:pl-12 pr-11 sm:pr-12 py-5 sm:py-6 rounded-2xl border-2 border-gray-200 focus:border-purple-400 transition-colors"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-2xl py-5 sm:py-6 text-base sm:text-lg shadow-lg hover:shadow-xl transition-all group"
              >
